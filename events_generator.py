...
def generate_event(event_id, entity_type, person_id=None, vehicle_id=None):
    """Helper to generate a single event."""
    ...
    if entity_type == "Person":
        ...
        shirt_color = None
        person_id = None
        additional_info = {"confidence": confidence, "license_plate": license_plate, "vehicle_color": vehicle_color}
...
if __name__ == "__main__":
    ...
    print("✅ 200 mock events saved to graph2_events.json")
